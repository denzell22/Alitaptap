<!-- connecting dashboard.php to connect.php -->
...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">   <!-- Completed Orders -->
         <?php
            $total_completes = 0;
      ...
      <div class="box">   <!-- No. of Normal Users -->
         <?php
      ...
      <div class="box">   <!-- No. of Admins Registered -->
         <?php
