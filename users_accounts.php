   <!-- connecting connect.php and setting up for user accounts functions -->
<?php
...
<head>
   ...
   <title>User Accounts</title>
      ...
      <!-- linking to stylesheets and ajax library -->
...
<section class="accounts">
   ...
   <div class="box-container">   <!-- selecting user info -->
   ...
   ?>
   <div class="box">   <!-- prompt for deleting an account -->
