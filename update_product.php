...
<section class="update-product">
   ...
   ?>
   <form action="" method="post" enctype="multipart/form-data">   <!-- preceeding image display -->
      ...
      <span>Update Name</span>   <!-- updata name -->
      <input type="text" name="name" required class="box" maxlength="100" placeholder="Enter Product Name" value="<?= $fetch_products['name']; ?>">
      <span>Update Price</span>   <!-- update price -->
      <input type="number" name="price" required class="box" min="0" max="9999999999" placeholder="Enter Product Price" onkeypress="if(this.value.length == 10) return false;" value="<?= $fetch_products['price']; ?>">
      <span>Update Details</span>   <!-- update details -->
      <textarea name="details" class="box" required cols="30" rows="10"><?= $fetch_products['details']; ?></textarea>

         <!-- updating image 1, 2 and 3-->
