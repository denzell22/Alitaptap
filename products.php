   ...
   if($select_products->rowCount() > 0){
      ...
      if($insert_products){
         if($image_size_01 > 2000000 OR $image_size_02 > 2000000 OR $image_size_03 > 2000000){
            ...
            $message[] = 'New Product Added Susccessfully!';
         }
...
<section class="add-products">
   ...
   <h1 class="heading">Add Product</h1>   <!-- add new product -->
...
<section class="show-products">   <!-- displaying produts that are already added -->
   ...
   ?>
   <div class="box">   <!-- update and delete -->
