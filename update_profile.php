   <!-- connecting connect.php and setting up for admin profile update functions -->
<?php
...
if(isset($_POST['submit'])){
   ...
   //entering old password to set up for new password
   $name = $_POST['name'];
...
<head>
   ...
   <title>Update Administrator Profile</title>
...
<?php include '../components/admin_header.php'; ?>   <!-- navbar -->

<section class="form-container">

   <form action="" method="post">
      <h3>Update Profile</h3>   <!-- updating profile -->
