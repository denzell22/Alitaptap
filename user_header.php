...
<header class="header">
   ...
   <section class="flex">   <!-- user header -->
      ...
      <div class="icons">   <!-- icons -->
         ...
         ?>
         <div id="menu-btn" class="fas fa-bars"></div>   <!-- search, wishlist, menu, cart, and user profile icons-->
      ...
      <div class="profile">
         ...
         <a href="update_user.php" class="btn">Update Profile</a>   <!-- updating user profile -->
         <div class="flex-btn">
