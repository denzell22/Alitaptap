...
<section class="products">
   ...
   <h1 class="heading">Product Catalogue</h1>
   ...
   ?>
   <form action="" method="post" class="box">   <!-- product info display -->
      ...
      <input type="submit" value="add to cart" class="btn" name="add_to_cart">   <!-- add to cart prompt -->
   </form>
   <?php
      }
   }else{
